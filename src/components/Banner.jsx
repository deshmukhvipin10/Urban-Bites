...
const Banner = () => {
    ...
    return (
        <div className='bg-white pt-12 md:pt-24 min-h-[500px] flex items-center'>
            {/* VIDEO MODEL */}
            {showVideo && (
                <div className='fixed insert-0 bg-black/50 z-50 flex items-center justify-center p-4'>
                    <div className='bg-white p-4 md:p-8 rounded-lg w-full max-w-4xl relative'>
                        <button onClick={() => setShowVideo(false)} className='absolute -top-8 right-0 text-white text-2xl'>
                            &times;
                        </button>
                        <div className='aspect-video'>
                            <iframe src={Bannervideo} width="100%" height="100%" allow='autoplay' allowFullScreen
                                className='rounded-lg'></iframe>
                        </div>
                    </div>
                </div>
            )}
            <div className='container mx-auto px-6 md:px-12 xl:px-20 flex flex-col lg:flex-row items-center justify-between
        gap-12'>
                {/* LEFT CONTENT */}
                <div className='w-full lg:flex-1 text-center lg:text-left'>
                    <h3 className='text-lg mt-5 m:text-xl lg:text-2xl font-bold font-comfortaa text-gray-600 mb-2 md:mb-3'>
                        Mane Dion Fuster
                    </h3>
                    <h1 className='text-3xl sm:text-4xl m:text-5xl lg:text-7xl xl:text-6xl font-pacifico animate-slide-up
                font-extrabold leading-tight mb-4'>
                    ...
                    <div className='flex flex-wrap justify-center lg:justify-start gap-4'>
                        ...
                        <button className='flex items-center gap-2 md:gap-3 group'
                            ...
                            justify-center transition group-hover:bg-red-600 group-hover:scale-110 shadow-lg
                            relative'>
                                <span className='absolute inset-0 animate-ping rounded-full bg-red-400
                                opacity-75'></span>
                                <span className='text-white text-lg'>&#9654;</span>
                            </span>
                            <span className='text-gray-600 group-hover:text-red-500 font-semibold text-sm
                            md:text-base'>
                                Watch Video
                            </span>
                        </button>
                ...
                {/* RIGHT SECTION */}
                <div className='w-full lg:flex-1 relative max-w-lg sm:max-w-md md:max-w-lg lg:max-w-none mx-auto'>
                    <div className='relative mx-auto'>
                        <img src={Bannerfood} alt="Banner food" className='w-full h-auto object-cover transform
                        -rotate-180 hover:rotate-1 transition duration-500' />
                        <div className='absolute left-2 sm:left-4 md:left-0 top-4 sm:top-6 w-14 sm:w-16
                        md:w-20'>
                        ...
                        <div className='relative'>
                            <img src={FireIcon} alt="Fire" className='w-10 sm:w-12 md:w-14 mb-20 sm:mb-32 md:mb-90' />
                            <img src={BannerArrow} alt="Arrow" className='w-10 sm:w-12 md:w-14 transform rotate-30 md:-mb-7' />
                        </div>
