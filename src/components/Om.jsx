...
const Om = () => {
    ...
    flex flex-col md:flex-col lg:flex-row items-center gap-8'>
            {/* LEFT SIDEBAR */}
            <div className="w-full md:w-3/4 lg:w-2/4 bg-white p-4 md:p-6 rounded-3xl shadow-3xl shadow-lg border border-amber-300">
            ...
            <div className="w-full lg-w-3/4 flex flex-col items-center">
                ...
                <h2 className="text-2xl md:text-3xl font-comfortaa font-bold mt-4 md:mt-3 text-gray-800">
                    {selectedItem.name}
                </h2>
                ...
                {/* NAVIGATION BUTTON */}
                <div className="mt-4 md:mt-4 flex gap-3 md:gap-4 lg:gap-6">
                    <button onClick={() => {
                        ...
                        className="p-2 md:p-3 bg-amber-600 text-white rounded-full shadow-lg
            hover:bg-amber-500 transition">
                ...
                <div className="mt-4 md:mt-6 flex items-center space-x-3 md:space-x-4 lg:space-x-6">
                    <div className="flex items-center justify-center p-2 md:p-3 bg-white rounded-full
                    shadow-xl transform transiton hover:scale-110">
