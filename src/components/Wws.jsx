...
lg:px-20 py-12 md:py-20 xl:py-24'>
    <div className='mx-auto text-center max-w-7xl'>
        ...
        font-poopins leading-tight mb-8 md:mb-12 lg:mb-16'>
  ...
  },
  {
    ...
    <div key={index} className='group relative rounded-xl p-4 sm:p-6 transition-transform duration-300'>
        <div className='overflow-hidden'>
            ...
            md:h-48 lg:h-56 xl:h-64 object-contain lg:object-cover transition-transform duartion-300' />
        </div>
        <h3  className='text-xl sm:text-2xl lg:text-2xl font-bold text-orange-600 mt-4
        sm:mt-6 font-poppins'>
            {service.title}
        </h3>
        <p className='text-base sm:text-lg text-gray-700 leading-relaxed mt-2
        sm:mt-2 px-2 sm:px-0'>
            {service.text}
        </p>
    </div>
))}
